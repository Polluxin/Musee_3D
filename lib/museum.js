 ...
 */
function createRectanglePath(x, y, w, h){
...
function createWall(width, height, depth){
    const wall = createRectangleShape(0, 0, width, height);

    // const adoor = createRectanglePath(1,1,width-1, height-1);
    // wall.holes.push( adoor );
